...
class Uploader {
  ...
  _createChunks () {
    ...
    let chunkIndex = 0;
    // As data comes in. build a chunk that is 5mb, when it reaches 5m, send it and start a new chunk.
    this.file.data.on('data', (streamChunk) => {
      ...
      if(chunk === null || chunk === undefined) {
        ...
        chunk = {
          ...
          data: null, // will be defined when this is completeley downloaded
          pieces: [],
