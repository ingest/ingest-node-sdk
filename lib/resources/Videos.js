...
class Videos extends Resource {
   ...
   * @param {string}          image.data        The image buffer
   * @param {string}          image.filename    The name of the image file
   * @param {string}          image.contentType The content type of the image being uploaded
   * @param {Function}        callback          (Optional) Callback to be called when the request is complete.
   */
