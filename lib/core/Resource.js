...
class Resource {
  ...
  _updateResourceArray (resources, callback) {
    if (!resources || !Array.isArray(resources)) {
      const error = new Error('IngestAPI Resource _updateResourceArray requires resources to be passed as an array.')
      return this._handleInputError(error, callback)
    }
  ...
  delete (resource, callback) {
    ...
    if (Array.isArray(resource)) {
      ...
      const error = new Error('IngestAPI Resource delete requires a resource id as string, or an array of string id\'s.')
      return this._handleInputError(error, callback)
    }
  };
  ...
  permanentDelete (resource, callback) {
    ...
    if (Array.isArray(resource)) {
      ...
      const error = new Error('IngestAPI Resource permanentDelete requires a resource id as string, or an array of string id\'s.') //eslint-disable-line
      return this._handleInputError(error, callback)
    }
  };
  ...
  _deleteResourceArray (resources, permanent, callback) {
    if (typeof permanent !== 'boolean') {
      const error = new Error('IngestAPI Resource _deleteResourceArray requires permanent to be passed as a boolean.')
      return this._handleInputError(error, callback)
    }

    if (!resources || !Array.isArray(resources)) {
      const error = new Error('IngestAPI Resource _deleteResourceArray requires a resources to be passed as an array.')
      return this._handleInputError(error, callback)
    }
